...
plotly.tools.set_credentials_file(username = 'jarrensj', api_key = 'gvon8gdbbp')#PhamousJ', api_key = 'csc7od4qv1')
stream_token1 = 'bckp5te5kv' #jarren token 5
stream_token2 = '4ddvmxorjr' #jarren token 6
